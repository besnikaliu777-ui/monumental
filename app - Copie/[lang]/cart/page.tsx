              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      {item.product.price.toLocaleString(locale, { style: 'currency', currency: 'CHF' })} × {item.quantity}
                    </p>
                ...
                <div className="text-right">
                  <p className="text-yellow-500 font-semibold">
                    {(item.product.price * item.quantity).toLocaleString(locale, {
                      style: 'currency',
                      currency: 'CHF',
                    })}
                  </p>
            ...
            <div className="flex justify-end mt-4">
              <div className="text-right">
                <p className="text-xl text-white font-bold">
                  {dict.common.total}: {total.toLocaleString(locale, { style: 'currency', currency: 'CHF' })}
                </p>
                <Link
